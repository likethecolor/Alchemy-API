...
public class CategoryParserTest {
  ...
  private static final String CATEGORY = "religion";
  ...
  public void testParse_CategoryNoScore() {
    final CategoryParser parser = new CategoryParser();
    final Response<CategoryAlchemyEntity> response = parser.parse(getJsonStringCategory());
  ...
  @Test
  public void testParse_ScoreNoCategory() {
    final CategoryParser parser = new CategoryParser();
    final Response<CategoryAlchemyEntity> response = parser.parse(getJsonStringScore());
  ...
  private String getJsonString() {
    return "{\"" + JSONConstants.RESULTS_STATUS + "\":\"" + STATUS_STRING + "\"," +
           ...
           "\"" + JSONConstants.CATEGORY_KEY + "\":\"" + CATEGORY + "\"," +
           "\"" + JSONConstants.CATEGORY_SCORE_KEY + "\":" + SCORE + "}";
  }

  /**
   * Has category, no score.
   */
  private String getJsonStringCategory() {
    return "{\"" + JSONConstants.RESULTS_STATUS + "\":\"" + STATUS_STRING + "\"," +
           "\"" + JSONConstants.RESULTS_USAGE + "\": \"" + USAGE + "\"," +
           "\"" + JSONConstants.RESULTS_URL + "\": \"" + URL + "\"," +
           "\"" + JSONConstants.RESULTS_LANGUAGE + "\": \"" + LANGUAGE + "\"," +
  ...
  /**
   * Has no category, has score.
   */
  private String getJsonStringScore() {
    return "{\"" + JSONConstants.RESULTS_STATUS + "\":\"" + STATUS_STRING + "\"," +
           "\"" + JSONConstants.RESULTS_USAGE + "\": \"" + USAGE + "\"," +
           "\"" + JSONConstants.RESULTS_URL + "\": \"" + URL + "\"," +
           "\"" + JSONConstants.RESULTS_LANGUAGE + "\": \"" + LANGUAGE + "\"," +
