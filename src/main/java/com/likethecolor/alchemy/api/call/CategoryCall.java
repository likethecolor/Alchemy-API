...
import com.likethecolor.alchemy.api.parser.json.CategoryParser;

public class CategoryCall extends AbstractCall<CategoryAlchemyEntity> {
  public CategoryCall(final CallType callType) {
    this(callType, new CategoryParams());
  }

  public CategoryCall(final CallType callType, final Params params) {
  ...
  public Response<CategoryAlchemyEntity> parse(String jsonString) {
    return new CategoryParser().parse(jsonString);
  }
}
