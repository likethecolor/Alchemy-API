...
import com.likethecolor.alchemy.api.validator.TextValidator;

public class CallTypeText implements CallType {
  private String text;

  public CallTypeText(final String text) {
  ...
  public String getPrefix() {
    return Constants.CALL_TYPE_PREFIX_TEXT;
  }

  public String getType() {
    return Constants.CALL_TYPE_TEXT;
  }
}
