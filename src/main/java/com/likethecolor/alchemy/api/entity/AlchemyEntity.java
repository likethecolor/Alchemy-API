...
/**
 * Named entity data for the detected subject and object (sent only if entity
 * extraction is enabled).
 *
 * @see <a href="http://www.alchemyapi.com/api/relation/urls.html">http://www.alchemyapi.com/api/relation/urls.html</a>
 */
public class AlchemyEntity {
  ...
  public AlchemyEntity(final String text, final String type) {
    setText(text);
    setType(type);
   ...
   *
   * @param disambiguatedAlchemyEntity {@link DisambiguatedAlchemyEntity} for this entity
   */
  public void setDisambiguatedAlchemyEntity(final DisambiguatedAlchemyEntity disambiguatedAlchemyEntity) {
    this.disambiguatedAlchemyEntity = disambiguatedAlchemyEntity;
  }
   ...
   */
  public AlchemyEntity clone() {
    final AlchemyEntity clone = new AlchemyEntity(getText(), getType());
  ...
  public boolean equals(Object o) {
    ...
    AlchemyEntity that = (AlchemyEntity) o;

    if(disambiguatedAlchemyEntity != null
       ? !disambiguatedAlchemyEntity.equals(that.disambiguatedAlchemyEntity)
       : that.disambiguatedAlchemyEntity != null) {
      return false;
    }
