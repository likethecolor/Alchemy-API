...
public class RelationParams extends Params {
  ...
  private boolean isRequireEntities;
  private boolean isSentiment;
  private boolean isSentimentExcludeEntities;
  ...
  public void setIsEntities(final boolean isEntities) {
  ...
  public void setIsRequireEntities(final boolean isRequireEntities) {
    this.isRequireEntities = isRequireEntities;
  }

  public boolean isRequireEntities() {
    return isRequireEntities;
  }
  ...
  public boolean isSentimentExcludeEntities() {
    return isSentimentExcludeEntities;
  }

  public void setIsSentimentExcludeEntities(final boolean isSentimentExcludeEntities) {
    this.isSentimentExcludeEntities = isSentimentExcludeEntities;
  }
  ...
  public String toString() {
    return new StringBuilder(super.toString())
        ...
        .append(createParam(Constants.PARAM_DISAMBIGUATE,
            isDisambiguate ? 1 : 0))
        .append(createParam(Constants.PARAM_ENTITIES, isEntities ? 1 : 0))
        ...
        .append(createParam(Constants.PARAM_REQUIRE_ENTITIES,
            isRequireEntities ? 1 : 0))
        .append(createParam(Constants.PARAM_SHOW_SENTIMENT,
            isSentiment ? 1 : 0))
        .append(createParam(Constants.PARAM_SHOW_SENTIMENT_EXCLUDE_ENTITIES,
